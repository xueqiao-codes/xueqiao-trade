...
class HostingComposeView:
  ...
  def __init__(self, subUserId=None, composeGraphId=None, aliasName=None, viewSource=None, subscribeStatus=None, createTimestamp=None, lastmodifyTimestamp=None,):
    self.subUserId = subUserId
    self.composeGraphId = composeGraphId
...
class HostingExecTrade:
  ...
  def write(self, oprot):
    ...
    if self.relatedTradeLegIds is not None:
      ...
      for iter91 in self.relatedTradeLegIds:
    ...
    if self.relatedTradeLegPrices is not None:
      ...
      for iter92 in self.relatedTradeLegPrices:
        oprot.writeDouble(iter92)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.relatedTradeLegTradeDirections is not None:
      ...
      for iter93 in self.relatedTradeLegTradeDirections:
