            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.subCommodityCodeNodes = new HashMap<String,HostingOrderRouteCommodityCodeNode>(2*_map56.size);
                for (int _i57 = 0; _i57 < _map56.size; ++_i57)
                {
                  String _key58;
                  HostingOrderRouteCommodityCodeNode _val59;
                  _key58 = iprot.readString();
                  _val59 = new HostingOrderRouteCommodityCodeNode();
                  _val59.read(iprot);
                  struct.subCommodityCodeNodes.put(_key58, _val59);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.subCommodityCodeNodes != null) {
        if (struct.isSetSubCommodityCodeNodes()) {
          oprot.writeFieldBegin(SUB_COMMODITY_CODE_NODES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, HostingOrderRouteCommodityCodeNode> _iter60 : struct.subCommodityCodeNodes.entrySet())
            {
      ...
      if (struct.isSetSubCommodityCodeNodes()) {
        {
          ...
          for (Map.Entry<String, HostingOrderRouteCommodityCodeNode> _iter61 : struct.subCommodityCodeNodes.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.subCommodityCodeNodes = new HashMap<String,HostingOrderRouteCommodityCodeNode>(2*_map62.size);
          for (int _i63 = 0; _i63 < _map62.size; ++_i63)
          {
            String _key64;
            HostingOrderRouteCommodityCodeNode _val65;
            _key64 = iprot.readString();
            _val65 = new HostingOrderRouteCommodityCodeNode();
            _val65.read(iprot);
            struct.subCommodityCodeNodes.put(_key64, _val65);
          }
        }
        struct.setSubCommodityCodeNodesIsSet(true);
      }
