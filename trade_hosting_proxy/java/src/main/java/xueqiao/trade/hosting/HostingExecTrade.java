            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.relatedTradeLegIds = new ArrayList<Long>(_list164.size);
                for (int _i165 = 0; _i165 < _list164.size; ++_i165)
                {
                  long _elem166;
                  _elem166 = iprot.readI64();
                  struct.relatedTradeLegIds.add(_elem166);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.relatedTradeLegPrices = new ArrayList<Double>(_list167.size);
                for (int _i168 = 0; _i168 < _list167.size; ++_i168)
                {
                  double _elem169;
                  _elem169 = iprot.readDouble();
                  struct.relatedTradeLegPrices.add(_elem169);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.relatedTradeLegTradeDirections = new ArrayList<HostingExecTradeDirection>(_list170.size);
                for (int _i171 = 0; _i171 < _list170.size; ++_i171)
                {
                  HostingExecTradeDirection _elem172;
                  _elem172 = HostingExecTradeDirection.findByValue(iprot.readI32());
                  struct.relatedTradeLegTradeDirections.add(_elem172);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.relatedTradeLegIds != null) {
        if (struct.isSetRelatedTradeLegIds()) {
          oprot.writeFieldBegin(RELATED_TRADE_LEG_IDS_FIELD_DESC);
          {
            ...
            for (long _iter173 : struct.relatedTradeLegIds)
            {
      ...
      if (struct.relatedTradeLegPrices != null) {
        if (struct.isSetRelatedTradeLegPrices()) {
          oprot.writeFieldBegin(RELATED_TRADE_LEG_PRICES_FIELD_DESC);
          {
            ...
            for (double _iter174 : struct.relatedTradeLegPrices)
            {
              oprot.writeDouble(_iter174);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.relatedTradeLegTradeDirections != null) {
        if (struct.isSetRelatedTradeLegTradeDirections()) {
          oprot.writeFieldBegin(RELATED_TRADE_LEG_TRADE_DIRECTIONS_FIELD_DESC);
          {
            ...
            for (HostingExecTradeDirection _iter175 : struct.relatedTradeLegTradeDirections)
            {
      ...
      if (struct.isSetRelatedTradeLegIds()) {
        {
          ...
          for (long _iter176 : struct.relatedTradeLegIds)
          {
      ...
      if (struct.isSetRelatedTradeLegPrices()) {
        {
          ...
          for (double _iter177 : struct.relatedTradeLegPrices)
          {
            oprot.writeDouble(_iter177);
          }
        }
      }
      if (struct.isSetOrderTradeDirection()) {
      ...
      if (struct.isSetRelatedTradeLegTradeDirections()) {
        {
          ...
          for (HostingExecTradeDirection _iter178 : struct.relatedTradeLegTradeDirections)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.relatedTradeLegIds = new ArrayList<Long>(_list179.size);
          for (int _i180 = 0; _i180 < _list179.size; ++_i180)
          {
            long _elem181;
            _elem181 = iprot.readI64();
            struct.relatedTradeLegIds.add(_elem181);
          }
        }
        struct.setRelatedTradeLegIdsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.relatedTradeLegPrices = new ArrayList<Double>(_list182.size);
          for (int _i183 = 0; _i183 < _list182.size; ++_i183)
          {
            double _elem184;
            _elem184 = iprot.readDouble();
            struct.relatedTradeLegPrices.add(_elem184);
          }
        }
        struct.setRelatedTradeLegPricesIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.relatedTradeLegTradeDirections = new ArrayList<HostingExecTradeDirection>(_list185.size);
          for (int _i186 = 0; _i186 < _list185.size; ++_i186)
          {
            HostingExecTradeDirection _elem187;
            _elem187 = HostingExecTradeDirection.findByValue(iprot.readI32());
            struct.relatedTradeLegTradeDirections.add(_elem187);
          }
        }
        struct.setRelatedTradeLegTradeDirectionsIsSet(true);
      }
