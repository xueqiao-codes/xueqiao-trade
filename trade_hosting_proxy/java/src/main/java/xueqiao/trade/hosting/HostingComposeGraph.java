            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.legs = new HashMap<String,HostingComposeLeg>(2*_map16.size);
                for (int _i17 = 0; _i17 < _map16.size; ++_i17)
                {
                  String _key18;
                  HostingComposeLeg _val19;
                  _key18 = iprot.readString();
                  _val19 = new HostingComposeLeg();
                  _val19.read(iprot);
                  struct.legs.put(_key18, _val19);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.legs != null) {
        if (struct.isSetLegs()) {
          oprot.writeFieldBegin(LEGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, HostingComposeLeg> _iter20 : struct.legs.entrySet())
            {
      ...
      if (struct.isSetLegs()) {
        {
          ...
          for (Map.Entry<String, HostingComposeLeg> _iter21 : struct.legs.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.legs = new HashMap<String,HostingComposeLeg>(2*_map22.size);
          for (int _i23 = 0; _i23 < _map22.size; ++_i23)
          {
            String _key24;
            HostingComposeLeg _val25;
            _key24 = iprot.readString();
            _val25 = new HostingComposeLeg();
            _val25.read(iprot);
            struct.legs.put(_key24, _val25);
          }
        }
        struct.setLegsIsSet(true);
      }
