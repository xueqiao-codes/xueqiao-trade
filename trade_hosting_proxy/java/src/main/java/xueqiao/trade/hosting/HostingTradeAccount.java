      ...
      if (struct.accountProperties != null) {
        if (struct.isSetAccountProperties()) {
          oprot.writeFieldBegin(ACCOUNT_PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter40 : struct.accountProperties.entrySet())
            {
      ...
      if (struct.isSetAccountProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter41 : struct.accountProperties.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.accountProperties = new HashMap<String,String>(2*_map42.size);
          for (int _i43 = 0; _i43 < _map42.size; ++_i43)
          {
            ...
            struct.accountProperties.put(_key44, _val45);
          }
        }
        struct.setAccountPropertiesIsSet(true);
      }
