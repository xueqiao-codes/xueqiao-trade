            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.subExchangeNodes = new HashMap<String,HostingOrderRouteExchangeNode>(2*_map96.size);
                for (int _i97 = 0; _i97 < _map96.size; ++_i97)
                {
                  String _key98;
                  HostingOrderRouteExchangeNode _val99;
                  _key98 = iprot.readString();
                  _val99 = new HostingOrderRouteExchangeNode();
                  _val99.read(iprot);
                  struct.subExchangeNodes.put(_key98, _val99);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.subExchangeNodes != null) {
        if (struct.isSetSubExchangeNodes()) {
          oprot.writeFieldBegin(SUB_EXCHANGE_NODES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, HostingOrderRouteExchangeNode> _iter100 : struct.subExchangeNodes.entrySet())
            {
      ...
      if (struct.isSetSubExchangeNodes()) {
        {
          ...
          for (Map.Entry<String, HostingOrderRouteExchangeNode> _iter101 : struct.subExchangeNodes.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.subExchangeNodes = new HashMap<String,HostingOrderRouteExchangeNode>(2*_map102.size);
          for (int _i103 = 0; _i103 < _map102.size; ++_i103)
          {
            String _key104;
            HostingOrderRouteExchangeNode _val105;
            _key104 = iprot.readString();
            _val105 = new HostingOrderRouteExchangeNode();
            _val105.read(iprot);
            struct.subExchangeNodes.put(_key104, _val105);
          }
        }
        struct.setSubExchangeNodesIsSet(true);
      }
