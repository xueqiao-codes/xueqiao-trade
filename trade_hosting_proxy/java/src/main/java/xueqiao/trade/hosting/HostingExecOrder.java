            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.notifyStateHandleInfos = new ArrayList<HostingUpsideNotifyStateHandleInfo>(_list148.size);
                for (int _i149 = 0; _i149 < _list148.size; ++_i149)
                {
                  HostingUpsideNotifyStateHandleInfo _elem150;
                  _elem150 = new HostingUpsideNotifyStateHandleInfo();
                  _elem150.read(iprot);
                  struct.notifyStateHandleInfos.add(_elem150);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.notifyStateHandleInfos != null) {
        if (struct.isSetNotifyStateHandleInfos()) {
          oprot.writeFieldBegin(NOTIFY_STATE_HANDLE_INFOS_FIELD_DESC);
          {
            ...
            for (HostingUpsideNotifyStateHandleInfo _iter151 : struct.notifyStateHandleInfos)
            {
      ...
      if (struct.isSetNotifyStateHandleInfos()) {
        {
          ...
          for (HostingUpsideNotifyStateHandleInfo _iter152 : struct.notifyStateHandleInfos)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.notifyStateHandleInfos = new ArrayList<HostingUpsideNotifyStateHandleInfo>(_list153.size);
          for (int _i154 = 0; _i154 < _list153.size; ++_i154)
          {
            HostingUpsideNotifyStateHandleInfo _elem155;
            _elem155 = new HostingUpsideNotifyStateHandleInfo();
            _elem155.read(iprot);
            struct.notifyStateHandleInfos.add(_elem155);
          }
        }
        struct.setNotifyStateHandleInfosIsSet(true);
      }
