            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.relatedLegs = new ArrayList<HostingExecOrderLegContractSummary>(_list116.size);
                for (int _i117 = 0; _i117 < _list116.size; ++_i117)
                {
                  HostingExecOrderLegContractSummary _elem118;
                  _elem118 = new HostingExecOrderLegContractSummary();
                  _elem118.read(iprot);
                  struct.relatedLegs.add(_elem118);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.relatedLegs != null) {
        if (struct.isSetRelatedLegs()) {
          oprot.writeFieldBegin(RELATED_LEGS_FIELD_DESC);
          {
            ...
            for (HostingExecOrderLegContractSummary _iter119 : struct.relatedLegs)
            {
      ...
      if (struct.isSetRelatedLegs()) {
        {
          ...
          for (HostingExecOrderLegContractSummary _iter120 : struct.relatedLegs)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.relatedLegs = new ArrayList<HostingExecOrderLegContractSummary>(_list121.size);
          for (int _i122 = 0; _i122 < _list121.size; ++_i122)
          {
            HostingExecOrderLegContractSummary _elem123;
            _elem123 = new HostingExecOrderLegContractSummary();
            _elem123.read(iprot);
            struct.relatedLegs.add(_elem123);
          }
        }
        struct.setRelatedLegsIsSet(true);
      }
