...
public class TFund implements org.apache.thrift.TBase<TFund, TFund._Fields>, java.io.Serializable, Cloneable, Comparable<TFund> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFund");
  ...
  static {
    schemes.put(StandardScheme.class, new TFundStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TFundTupleSchemeFactory());
  }
  ...
  private static final int __PREBALANCE_ISSET_ID = 1;
  private static final int __DEPOSIT_ISSET_ID = 2;
  private static final int __WITHDRAW_ISSET_ID = 3;
  private static final int __FROZENMARGIN_ISSET_ID = 4;
  private static final int __FROZENCASH_ISSET_ID = 5;
  private static final int __CURRMARGIN_ISSET_ID = 6;
  private static final int __COMMISSION_ISSET_ID = 7;
  private static final int __CLOSEPROFIT_ISSET_ID = 8;
  private static final int __POSITIONPROFIT_ISSET_ID = 9;
  private static final int __AVAILABLE_ISSET_ID = 10;
  private static final int __DYNAMICBENEFIT_ISSET_ID = 11;
  private static final int __RISKRATE_ISSET_ID = 12;
  private short __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.CURRENCY_NO,_Fields.CURRENCY_CHANNEL,_Fields.CREDIT,_Fields.PRE_BALANCE,_Fields.DEPOSIT,_Fields.WITHDRAW,_Fields.FROZEN_MARGIN,_Fields.FROZEN_CASH,_Fields.CURR_MARGIN,_Fields.COMMISSION,_Fields.CLOSE_PROFIT,_Fields.POSITION_PROFIT,_Fields.AVAILABLE,_Fields.DYNAMIC_BENEFIT,_Fields.RISK_RATE};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFund.class, metaDataMap);
  }
  ...
  public TFund deepCopy() {
    return new TFund(this);
  }
  ...
  public TFund setCurrencyNo(String currencyNo) {
  ...
  public TFund setCurrencyChannel(String currencyChannel) {
  ...
  public TFund setCredit(double credit) {
    this.credit = credit;
    setCreditIsSet(true);
    return this;
  }
  ...
  public TFund setPreBalance(double preBalance) {
  ...
  public TFund setDeposit(double deposit) {
  ...
  public TFund setWithdraw(double withdraw) {
  ...
  public TFund setFrozenMargin(double frozenMargin) {
  ...
  public TFund setFrozenCash(double frozenCash) {
  ...
  public TFund setCurrMargin(double currMargin) {
  ...
  public TFund setCommission(double commission) {
  ...
  public TFund setCloseProfit(double closeProfit) {
  ...
  public TFund setPositionProfit(double positionProfit) {
  ...
  public TFund setAvailable(double available) {
  ...
  public TFund setDynamicBenefit(double dynamicBenefit) {
  ...
  public TFund setRiskRate(double riskRate) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TFund)
      return this.equals((TFund)that);
    return false;
  }

  public boolean equals(TFund that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TFund other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TFund(");
    boolean first = true;
  ...
  private static class TFundStandardSchemeFactory implements SchemeFactory {
    public TFundStandardScheme getScheme() {
      return new TFundStandardScheme();
    }
  }

  private static class TFundStandardScheme extends StandardScheme<TFund> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFund struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFund struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TFundTupleSchemeFactory implements SchemeFactory {
    public TFundTupleScheme getScheme() {
      return new TFundTupleScheme();
    }
  }

  private static class TFundTupleScheme extends TupleScheme<TFund> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFund struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFund struct) throws org.apache.thrift.TException {
