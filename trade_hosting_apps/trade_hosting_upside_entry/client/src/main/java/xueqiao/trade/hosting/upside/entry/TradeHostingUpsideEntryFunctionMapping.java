...
public class TradeHostingUpsideEntryFunctionMapping {
  ...
  static {
    ...
    putEntry("getLastUpsideEffectiveTimestamp",20);
    putEntry("sendUpsideHeartBeat",21);
    putEntry("dumpPositionSummaries",22);
    putEntry("getFunds",23);
    putEntry("getSettlementInfo",24);
    putEntry("getNetPositionSummaries",25);
    putEntry("getPositionInfos",26);
    putEntry("getPositionRateDetails",30);
  }
