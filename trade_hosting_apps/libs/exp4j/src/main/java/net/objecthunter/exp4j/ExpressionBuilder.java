...
public class ExpressionBuilder {
    ...
    private boolean buildInUseBigDecimal = false;
    ...
    public ExpressionBuilder buildinUseBigDecimal(boolean enabled) {
        this.buildInUseBigDecimal = enabled;
        return this;
    }
    ...
    public Expression build() {
        ...
        return new Expression(ShuntingYard.convertToRPN(this.expression
                ...
                , this.buildInUseBigDecimal), this.userFunctions.keySet());
    }
