...
import net.objecthunter.exp4j.operator.BigDecimalOperators;
...
public class Tokenizer {
    ...
    private final boolean buildInUseBigDecimal;
    ...
    public Tokenizer(String expression
            ...
            , final boolean buildInUseBigDecimal) {
        ...
        this.buildInUseBigDecimal = buildInUseBigDecimal;
    }
...
//        this.buildInUseBigDecimal = false;
//    }
    ...
    private Operator getOperator(String symbol) {
        ...
        if (op == null && symbol.length() == 1) {
            ...
            if (buildInUseBigDecimal) {
                op = BigDecimalOperators.getBuiltinOperator(symbol.charAt(0), argc);
            } else {
