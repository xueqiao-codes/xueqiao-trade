...
public abstract class JMXCall<T> {
	...
	private final String jmxProcessName;
	
	public JMXCall(final ProxyClient proxyClient, int jmxPort, String jmxProcessName) {
		...
		this.jmxProcessName = jmxProcessName;
	}
	...
	public String getJmxProcessName() {
	    return jmxProcessName;
	}
}
