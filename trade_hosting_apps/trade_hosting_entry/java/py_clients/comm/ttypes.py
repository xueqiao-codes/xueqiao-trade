...
class PlatformArgs:
  ...
  thrift_spec = (
    ...
    (9, TType.MAP, 'extraParams', (TType.STRING,None,TType.STRING,None), None, ), # 9
  )

  def __init__(self, sourceDesc=None, sourceIpV4=None, remoteAddress=None, remotePort=None, xForwardAddress=None, sourceIp=None, timeoutMs=None, clientLang=thrift_spec[8][4], extraParams=None,):
  ...
  def write(self, oprot):
    ...
    if self.extraParams is not None:
      oprot.writeFieldBegin('extraParams', TType.MAP, 9)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.extraParams))
      for kiter7,viter8 in self.extraParams.items():
