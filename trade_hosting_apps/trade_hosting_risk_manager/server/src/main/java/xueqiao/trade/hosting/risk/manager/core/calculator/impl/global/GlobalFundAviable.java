...
public class GlobalFundAviable extends GlobalCalculator {
    ...
    protected void onCalculate(RawDataPool rawDataPool, RiskItemValue newValue) {
        ...
        if (hostingFund != null && hostingFund.isSetAvailableFund()) {
            newValue.setValue(hostingFund.getAvailableFund());
        }
    }
}
