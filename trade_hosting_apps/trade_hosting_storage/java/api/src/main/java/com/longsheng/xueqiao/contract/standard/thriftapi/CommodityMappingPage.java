            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.page = new ArrayList<CommodityMapping>(_list184.size);
                for (int _i185 = 0; _i185 < _list184.size; ++_i185)
                {
                  CommodityMapping _elem186;
                  _elem186 = new CommodityMapping();
                  _elem186.read(iprot);
      ...
      if (struct.page != null) {
        if (struct.isSetPage()) {
          oprot.writeFieldBegin(PAGE_FIELD_DESC);
          {
            ...
            for (CommodityMapping _iter187 : struct.page)
            {
      ...
      if (struct.isSetPage()) {
        {
          ...
          for (CommodityMapping _iter188 : struct.page)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.page = new ArrayList<CommodityMapping>(_list189.size);
          for (int _i190 = 0; _i190 < _list189.size; ++_i190)
          {
            CommodityMapping _elem191;
            _elem191 = new CommodityMapping();
            _elem191.read(iprot);
