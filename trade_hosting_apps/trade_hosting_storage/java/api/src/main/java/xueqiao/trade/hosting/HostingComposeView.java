...
public class HostingComposeView implements org.apache.thrift.TBase<HostingComposeView, HostingComposeView._Fields>, java.io.Serializable, Cloneable, Comparable<HostingComposeView> {
  ...
  private static final org.apache.thrift.protocol.TField VIEW_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("viewStatus", org.apache.thrift.protocol.TType.I32, (short)6);
  private static final org.apache.thrift.protocol.TField PRECISION_NUMBER_FIELD_DESC = new org.apache.thrift.protocol.TField("precisionNumber", org.apache.thrift.protocol.TType.I16, (short)7);
  ...
  /**
   * 
   * @see HostingComposeViewStatus
   */
  public HostingComposeViewStatus viewStatus; // optional
  public short precisionNumber; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * @see HostingComposeViewStatus
     */
    VIEW_STATUS((short)6, "viewStatus"),
    PRECISION_NUMBER((short)7, "precisionNumber"),
  ...
  private static final int __PRECISIONNUMBER_ISSET_ID = 2;
  private static final int __CREATETIMESTAMP_ISSET_ID = 3;
  private static final int __LASTMODIFYTIMESTAMP_ISSET_ID = 4;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.SUB_USER_ID,_Fields.COMPOSE_GRAPH_ID,_Fields.ALIAS_NAME,_Fields.VIEW_SOURCE,_Fields.SUBSCRIBE_STATUS,_Fields.VIEW_STATUS,_Fields.PRECISION_NUMBER,_Fields.CREATE_TIMESTAMP,_Fields.LASTMODIFY_TIMESTAMP};
  ...
  static {
    ...
    tmpMap.put(_Fields.VIEW_STATUS, new org.apache.thrift.meta_data.FieldMetaData("viewStatus", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, HostingComposeViewStatus.class)));
    tmpMap.put(_Fields.PRECISION_NUMBER, new org.apache.thrift.meta_data.FieldMetaData("precisionNumber", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public HostingComposeView(HostingComposeView other) {
    ...
    if (other.isSetViewStatus()) {
      this.viewStatus = other.viewStatus;
    }
    this.precisionNumber = other.precisionNumber;
  ...
  public void clear() {
    ...
    setPrecisionNumberIsSet(false);
    this.precisionNumber = 0;
   ...
   * @see HostingComposeViewStatus
   */
  public HostingComposeView setViewStatus(HostingComposeViewStatus viewStatus) {
  ...
  /** Returns true if field viewStatus is set (has been assigned a value) and false otherwise */
  public boolean isSetViewStatus() {
    return this.viewStatus != null;
  }

  public void setViewStatusIsSet(boolean value) {
    if (!value) {
      this.viewStatus = null;
    }
  }

  public short getPrecisionNumber() {
    return this.precisionNumber;
  }

  public HostingComposeView setPrecisionNumber(short precisionNumber) {
    this.precisionNumber = precisionNumber;
    setPrecisionNumberIsSet(true);
    return this;
  }

  public void unsetPrecisionNumber() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __PRECISIONNUMBER_ISSET_ID);
  }

  /** Returns true if field precisionNumber is set (has been assigned a value) and false otherwise */
  public boolean isSetPrecisionNumber() {
    return EncodingUtils.testBit(__isset_bitfield, __PRECISIONNUMBER_ISSET_ID);
  }

  public void setPrecisionNumberIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __PRECISIONNUMBER_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VIEW_STATUS:
      if (value == null) {
        ...
        setViewStatus((HostingComposeViewStatus)value);
      }
      break;

    case PRECISION_NUMBER:
      if (value == null) {
        unsetPrecisionNumber();
      } else {
        setPrecisionNumber((Short)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case PRECISION_NUMBER:
      return Short.valueOf(getPrecisionNumber());
  ...
  public boolean isSet(_Fields field) {
    ...
    case VIEW_STATUS:
      return isSetViewStatus();
    case PRECISION_NUMBER:
      return isSetPrecisionNumber();
    case CREATE_TIMESTAMP:
  ...
  public boolean equals(HostingComposeView that) {
    ...
    boolean this_present_viewStatus = true && this.isSetViewStatus();
    boolean that_present_viewStatus = true && that.isSetViewStatus();
    if (this_present_viewStatus || that_present_viewStatus) {
      if (!(this_present_viewStatus && that_present_viewStatus))
        return false;
      if (!this.viewStatus.equals(that.viewStatus))
        return false;
    }

    boolean this_present_precisionNumber = true && this.isSetPrecisionNumber();
    boolean that_present_precisionNumber = true && that.isSetPrecisionNumber();
    if (this_present_precisionNumber || that_present_precisionNumber) {
      if (!(this_present_precisionNumber && that_present_precisionNumber))
        return false;
      if (this.precisionNumber != that.precisionNumber)
        return false;
    }
  ...
  public int compareTo(HostingComposeView other) {
    ...
    lastComparison = Boolean.valueOf(isSetViewStatus()).compareTo(other.isSetViewStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetViewStatus()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.viewStatus, other.viewStatus);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPrecisionNumber()).compareTo(other.isSetPrecisionNumber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPrecisionNumber()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.precisionNumber, other.precisionNumber);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetPrecisionNumber()) {
      ...
      sb.append(this.precisionNumber);
      first = false;
    }
    if (isSetCreateTimestamp()) {
      if (!first) sb.append(", ");
  ...
  private static class HostingComposeViewStandardScheme extends StandardScheme<HostingComposeView> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, HostingComposeView struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // VIEW_STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.viewStatus = HostingComposeViewStatus.findByValue(iprot.readI32());
              struct.setViewStatusIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 7: // PRECISION_NUMBER
            if (schemeField.type == org.apache.thrift.protocol.TType.I16) {
              struct.precisionNumber = iprot.readI16();
              struct.setPrecisionNumberIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HostingComposeView struct) throws org.apache.thrift.TException {
      ...
      if (struct.viewStatus != null) {
        if (struct.isSetViewStatus()) {
          oprot.writeFieldBegin(VIEW_STATUS_FIELD_DESC);
          oprot.writeI32(struct.viewStatus.getValue());
          oprot.writeFieldEnd();
        }
      }
      if (struct.isSetPrecisionNumber()) {
        oprot.writeFieldBegin(PRECISION_NUMBER_FIELD_DESC);
        oprot.writeI16(struct.precisionNumber);
        oprot.writeFieldEnd();
      }
