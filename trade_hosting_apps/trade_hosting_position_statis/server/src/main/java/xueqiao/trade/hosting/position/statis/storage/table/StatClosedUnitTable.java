...
public class StatClosedUnitTable extends TableHelper<StatClosedUnit> implements IDBTable {

    private final static String TABLE_NAME = "stat_close_unit";

    private final static String F_CLOSED_UNIT_ID = "Fclosed_unit_id";
    ...
    public StatClosedUnitTable(Connection conn) {
        super(conn);
    }
    ...
    public int insert(StatClosedUnit statClosedUnit) throws SQLException {
        ...
        pf.addLong(F_CLOSED_UNIT_ID, statClosedUnit.getClosedUnitId());
     ...
     * 查询
     */
    public List<StatClosedUnit> queryStatClosedUnitList(long closedItemId) throws SQLException {
     ...
     * 删除
     */
    public void deleteStatClosedUnit(long closedItemId) throws SQLException {
        super.delete(F_CLOSED_ITEM_ID + "=?", closedItemId);
    }
    ...
    public StatClosedUnit fromResultSet(ResultSet resultSet) throws Exception {
        ...
        closedUnit.setClosedUnitId(resultSet.getLong(F_CLOSED_UNIT_ID));
    ...
    public void onUpgradeOneStep(IDBOperator operator, int targetVersion) throws SQLException {
        if (2 == targetVersion) {
            ...
            createSqlBuilder.append("CREATE TABLE IF NOT EXISTS ").append(getTableName()).append("(")
                    .append(F_CLOSED_UNIT_ID).append(" BIGINT UNSIGNED NOT NULL DEFAULT 0,")
                    ...
                    .append("PRIMARY KEY(").append(F_CLOSED_UNIT_ID).append("),")
