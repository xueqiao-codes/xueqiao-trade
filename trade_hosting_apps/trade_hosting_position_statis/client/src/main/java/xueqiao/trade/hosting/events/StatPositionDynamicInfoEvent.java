 ...
 */
public class StatPositionDynamicInfoEvent implements org.apache.thrift.TBase<StatPositionDynamicInfoEvent, StatPositionDynamicInfoEvent._Fields>, java.io.Serializable, Cloneable, Comparable<StatPositionDynamicInfoEvent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StatPositionDynamicInfoEvent");
  ...
  private static final org.apache.thrift.protocol.TField POSITION_DYNAMIC_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("positionDynamicInfo", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  static {
    schemes.put(StandardScheme.class, new StatPositionDynamicInfoEventStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StatPositionDynamicInfoEventTupleSchemeFactory());
  }
  ...
  public xueqiao.trade.hosting.position.statis.StatPositionDynamicInfo positionDynamicInfo; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    POSITION_DYNAMIC_INFO((short)4, "positionDynamicInfo"),
  ...
  private _Fields optionals[] = {_Fields.SUB_ACCOUNT_ID,_Fields.TARGET_KEY,_Fields.TARGET_TYPE,_Fields.POSITION_DYNAMIC_INFO,_Fields.EVENT_CREATE_TIMESTAMP_MS};
  ...
  static {
    ...
    tmpMap.put(_Fields.POSITION_DYNAMIC_INFO, new org.apache.thrift.meta_data.FieldMetaData("positionDynamicInfo", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, xueqiao.trade.hosting.position.statis.StatPositionDynamicInfo.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StatPositionDynamicInfoEvent.class, metaDataMap);
  }
   ...
   */
  public StatPositionDynamicInfoEvent(StatPositionDynamicInfoEvent other) {
    ...
    if (other.isSetPositionDynamicInfo()) {
      this.positionDynamicInfo = new xueqiao.trade.hosting.position.statis.StatPositionDynamicInfo(other.positionDynamicInfo);
    }
    this.eventCreateTimestampMs = other.eventCreateTimestampMs;
  }

  public StatPositionDynamicInfoEvent deepCopy() {
    return new StatPositionDynamicInfoEvent(this);
  }
  ...
  public StatPositionDynamicInfoEvent setSubAccountId(long subAccountId) {
  ...
  public StatPositionDynamicInfoEvent setTargetKey(String targetKey) {
   ...
   * @see xueqiao.trade.hosting.arbitrage.thriftapi.HostingXQTargetType
   */
  public StatPositionDynamicInfoEvent setTargetType(xueqiao.trade.hosting.arbitrage.thriftapi.HostingXQTargetType targetType) {
  ...
  public xueqiao.trade.hosting.position.statis.StatPositionDynamicInfo getPositionDynamicInfo() {
    return this.positionDynamicInfo;
  }

  public StatPositionDynamicInfoEvent setPositionDynamicInfo(xueqiao.trade.hosting.position.statis.StatPositionDynamicInfo positionDynamicInfo) {
  ...
  public StatPositionDynamicInfoEvent setEventCreateTimestampMs(long eventCreateTimestampMs) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case POSITION_DYNAMIC_INFO:
      if (value == null) {
        ...
        setPositionDynamicInfo((xueqiao.trade.hosting.position.statis.StatPositionDynamicInfo)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StatPositionDynamicInfoEvent)
      return this.equals((StatPositionDynamicInfoEvent)that);
    return false;
  }

  public boolean equals(StatPositionDynamicInfoEvent that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(StatPositionDynamicInfoEvent other) {
  ...
  private static class StatPositionDynamicInfoEventStandardSchemeFactory implements SchemeFactory {
    public StatPositionDynamicInfoEventStandardScheme getScheme() {
      return new StatPositionDynamicInfoEventStandardScheme();
    }
  }

  private static class StatPositionDynamicInfoEventStandardScheme extends StandardScheme<StatPositionDynamicInfoEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StatPositionDynamicInfoEvent struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // POSITION_DYNAMIC_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.positionDynamicInfo = new xueqiao.trade.hosting.position.statis.StatPositionDynamicInfo();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatPositionDynamicInfoEvent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class StatPositionDynamicInfoEventTupleSchemeFactory implements SchemeFactory {
    public StatPositionDynamicInfoEventTupleScheme getScheme() {
      return new StatPositionDynamicInfoEventTupleScheme();
    }
  }

  private static class StatPositionDynamicInfoEventTupleScheme extends TupleScheme<StatPositionDynamicInfoEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StatPositionDynamicInfoEvent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StatPositionDynamicInfoEvent struct) throws org.apache.thrift.TException {
