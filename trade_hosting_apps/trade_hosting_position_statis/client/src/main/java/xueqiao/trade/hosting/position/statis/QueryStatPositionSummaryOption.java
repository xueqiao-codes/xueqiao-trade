...
public class QueryStatPositionSummaryOption implements org.apache.thrift.TBase<QueryStatPositionSummaryOption, QueryStatPositionSummaryOption._Fields>, java.io.Serializable, Cloneable, Comparable<QueryStatPositionSummaryOption> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QueryStatPositionSummaryOption");
  ...
  static {
    schemes.put(StandardScheme.class, new QueryStatPositionSummaryOptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QueryStatPositionSummaryOptionTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.TARGET_KEY,_Fields.TARGET_TYPE};
  public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.SUB_ACCOUNT_ID, new org.apache.thrift.meta_data.FieldMetaData("subAccountId", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryStatPositionSummaryOption.class, metaDataMap);
  }
   ...
   */
  public QueryStatPositionSummaryOption(QueryStatPositionSummaryOption other) {
  ...
  public QueryStatPositionSummaryOption deepCopy() {
    return new QueryStatPositionSummaryOption(this);
  }
  ...
  public QueryStatPositionSummaryOption setSubAccountId(long subAccountId) {
    this.subAccountId = subAccountId;
    setSubAccountIdIsSet(true);
    return this;
  }
  ...
  public QueryStatPositionSummaryOption setTargetKey(String targetKey) {
   ...
   * @see xueqiao.trade.hosting.arbitrage.thriftapi.HostingXQTargetType
   */
  public QueryStatPositionSummaryOption setTargetType(xueqiao.trade.hosting.arbitrage.thriftapi.HostingXQTargetType targetType) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryStatPositionSummaryOption)
      return this.equals((QueryStatPositionSummaryOption)that);
    return false;
  }

  public boolean equals(QueryStatPositionSummaryOption that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(QueryStatPositionSummaryOption other) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'subAccountId' because it's a primitive and you chose the non-beans generator.
  ...
  private static class QueryStatPositionSummaryOptionStandardSchemeFactory implements SchemeFactory {
    public QueryStatPositionSummaryOptionStandardScheme getScheme() {
      return new QueryStatPositionSummaryOptionStandardScheme();
    }
  }

  private static class QueryStatPositionSummaryOptionStandardScheme extends StandardScheme<QueryStatPositionSummaryOption> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, QueryStatPositionSummaryOption struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetSubAccountId()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'subAccountId' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }

    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryStatPositionSummaryOption struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class QueryStatPositionSummaryOptionTupleSchemeFactory implements SchemeFactory {
    public QueryStatPositionSummaryOptionTupleScheme getScheme() {
      return new QueryStatPositionSummaryOptionTupleScheme();
    }
  }

  private static class QueryStatPositionSummaryOptionTupleScheme extends TupleScheme<QueryStatPositionSummaryOption> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, QueryStatPositionSummaryOption struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, QueryStatPositionSummaryOption struct) throws org.apache.thrift.TException {
