...
public class StatMergeToComposeReq implements org.apache.thrift.TBase<StatMergeToComposeReq, StatMergeToComposeReq._Fields>, java.io.Serializable, Cloneable, Comparable<StatMergeToComposeReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("StatMergeToComposeReq");
  ...
  private static final org.apache.thrift.protocol.TField COMPOSE_PRICE_FIELD_DESC = new org.apache.thrift.protocol.TField("composePrice", org.apache.thrift.protocol.TType.DOUBLE, (short)3);
  ...
  private static final org.apache.thrift.protocol.TField MERGE_COMPOSE_LEG_DATA_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("mergeComposeLegDataList", org.apache.thrift.protocol.TType.LIST, (short)10);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new StatMergeToComposeReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StatMergeToComposeReqTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    MERGE_COMPOSE_LEG_DATA_LIST((short)10, "mergeComposeLegDataList");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // COMPOSE_PRICE
          return COMPOSE_PRICE;
        case 4: // VOLUME
          return VOLUME;
        case 5: // DIRETION
          return DIRETION;
        case 10: // MERGE_COMPOSE_LEG_DATA_LIST
          return MERGE_COMPOSE_LEG_DATA_LIST;
        default:
          return null;
      }
    }
  ...
  private static final int __COMPOSEPRICE_ISSET_ID = 2;
  private static final int __VOLUME_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.SUB_ACCOUNT_ID,_Fields.COMPOSE_GRAPH_ID,_Fields.COMPOSE_PRICE,_Fields.VOLUME,_Fields.DIRETION,_Fields.MERGE_COMPOSE_LEG_DATA_LIST};
  ...
  static {
    ...
    tmpMap.put(_Fields.MERGE_COMPOSE_LEG_DATA_LIST, new org.apache.thrift.meta_data.FieldMetaData("mergeComposeLegDataList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MergeComposeLegData.class))));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StatMergeToComposeReq.class, metaDataMap);
  }
   ...
   */
  public StatMergeToComposeReq(StatMergeToComposeReq other) {
    ...
    if (other.isSetMergeComposeLegDataList()) {
      List<MergeComposeLegData> __this__mergeComposeLegDataList = new ArrayList<MergeComposeLegData>(other.mergeComposeLegDataList.size());
      for (MergeComposeLegData other_element : other.mergeComposeLegDataList) {
        __this__mergeComposeLegDataList.add(new MergeComposeLegData(other_element));
      }
      this.mergeComposeLegDataList = __this__mergeComposeLegDataList;
    }
  }

  public StatMergeToComposeReq deepCopy() {
    return new StatMergeToComposeReq(this);
  }
  ...
  public void clear() {
    ...
    this.volume = 0;
    this.diretion = null;
    this.mergeComposeLegDataList = null;
  }
  ...
  public StatMergeToComposeReq setSubAccountId(long subAccountId) {
  ...
  public StatMergeToComposeReq setComposeGraphId(long composeGraphId) {
  ...
  public StatMergeToComposeReq setComposePrice(double composePrice) {
  ...
  public StatMergeToComposeReq setVolume(int volume) {
    this.volume = volume;
    setVolumeIsSet(true);
    return this;
  }
   ...
   * @see StatDirection
   */
  public StatMergeToComposeReq setDiretion(StatDirection diretion) {
  ...
  public int getMergeComposeLegDataListSize() {
    return (this.mergeComposeLegDataList == null) ? 0 : this.mergeComposeLegDataList.size();
  }

  public java.util.Iterator<MergeComposeLegData> getMergeComposeLegDataListIterator() {
    return (this.mergeComposeLegDataList == null) ? null : this.mergeComposeLegDataList.iterator();
  }

  public void addToMergeComposeLegDataList(MergeComposeLegData elem) {
    if (this.mergeComposeLegDataList == null) {
      this.mergeComposeLegDataList = new ArrayList<MergeComposeLegData>();
    }
    this.mergeComposeLegDataList.add(elem);
  }

  public List<MergeComposeLegData> getMergeComposeLegDataList() {
    return this.mergeComposeLegDataList;
  }

  public StatMergeToComposeReq setMergeComposeLegDataList(List<MergeComposeLegData> mergeComposeLegDataList) {
    this.mergeComposeLegDataList = mergeComposeLegDataList;
    return this;
  }

  public void unsetMergeComposeLegDataList() {
    this.mergeComposeLegDataList = null;
  }

  /** Returns true if field mergeComposeLegDataList is set (has been assigned a value) and false otherwise */
  public boolean isSetMergeComposeLegDataList() {
    return this.mergeComposeLegDataList != null;
  }

  public void setMergeComposeLegDataListIsSet(boolean value) {
    if (!value) {
      this.mergeComposeLegDataList = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MERGE_COMPOSE_LEG_DATA_LIST:
      if (value == null) {
        unsetMergeComposeLegDataList();
      } else {
        setMergeComposeLegDataList((List<MergeComposeLegData>)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case MERGE_COMPOSE_LEG_DATA_LIST:
      return getMergeComposeLegDataList();
  ...
  public boolean isSet(_Fields field) {
    ...
    case MERGE_COMPOSE_LEG_DATA_LIST:
      return isSetMergeComposeLegDataList();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StatMergeToComposeReq)
      return this.equals((StatMergeToComposeReq)that);
    return false;
  }

  public boolean equals(StatMergeToComposeReq that) {
    if (that == null)
      return false;
    ...
    boolean this_present_mergeComposeLegDataList = true && this.isSetMergeComposeLegDataList();
    boolean that_present_mergeComposeLegDataList = true && that.isSetMergeComposeLegDataList();
    if (this_present_mergeComposeLegDataList || that_present_mergeComposeLegDataList) {
      if (!(this_present_mergeComposeLegDataList && that_present_mergeComposeLegDataList))
        return false;
      if (!this.mergeComposeLegDataList.equals(that.mergeComposeLegDataList))
        return false;
    }
  ...
  @Override
  public int compareTo(StatMergeToComposeReq other) {
    ...
    lastComparison = Boolean.valueOf(isSetMergeComposeLegDataList()).compareTo(other.isSetMergeComposeLegDataList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMergeComposeLegDataList()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mergeComposeLegDataList, other.mergeComposeLegDataList);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetMergeComposeLegDataList()) {
      ...
      if (this.mergeComposeLegDataList == null) {
        ...
        sb.append(this.mergeComposeLegDataList);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class StatMergeToComposeReqStandardSchemeFactory implements SchemeFactory {
    public StatMergeToComposeReqStandardScheme getScheme() {
      return new StatMergeToComposeReqStandardScheme();
    }
  }

  private static class StatMergeToComposeReqStandardScheme extends StandardScheme<StatMergeToComposeReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, StatMergeToComposeReq struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mergeComposeLegDataList = new ArrayList<MergeComposeLegData>(_list76.size);
                for (int _i77 = 0; _i77 < _list76.size; ++_i77)
                {
                  MergeComposeLegData _elem78;
                  _elem78 = new MergeComposeLegData();
                  _elem78.read(iprot);
                  struct.mergeComposeLegDataList.add(_elem78);
                }
                iprot.readListEnd();
              }
              struct.setMergeComposeLegDataListIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StatMergeToComposeReq struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.mergeComposeLegDataList != null) {
        if (struct.isSetMergeComposeLegDataList()) {
          oprot.writeFieldBegin(MERGE_COMPOSE_LEG_DATA_LIST_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.mergeComposeLegDataList.size()));
            for (MergeComposeLegData _iter79 : struct.mergeComposeLegDataList)
            {
              _iter79.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class StatMergeToComposeReqTupleSchemeFactory implements SchemeFactory {
    public StatMergeToComposeReqTupleScheme getScheme() {
      return new StatMergeToComposeReqTupleScheme();
    }
  }

  private static class StatMergeToComposeReqTupleScheme extends TupleScheme<StatMergeToComposeReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, StatMergeToComposeReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMergeComposeLegDataList()) {
        {
          oprot.writeI32(struct.mergeComposeLegDataList.size());
          for (MergeComposeLegData _iter80 : struct.mergeComposeLegDataList)
          {
            _iter80.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, StatMergeToComposeReq struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.mergeComposeLegDataList = new ArrayList<MergeComposeLegData>(_list81.size);
          for (int _i82 = 0; _i82 < _list81.size; ++_i82)
          {
            MergeComposeLegData _elem83;
            _elem83 = new MergeComposeLegData();
            _elem83.read(iprot);
            struct.mergeComposeLegDataList.add(_elem83);
          }
        }
        struct.setMergeComposeLegDataListIsSet(true);
      }
