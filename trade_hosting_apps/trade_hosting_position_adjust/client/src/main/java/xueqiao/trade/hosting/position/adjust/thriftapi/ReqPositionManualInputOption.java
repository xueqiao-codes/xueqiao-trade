 ...
 */
public class ReqPositionManualInputOption implements org.apache.thrift.TBase<ReqPositionManualInputOption, ReqPositionManualInputOption._Fields>, java.io.Serializable, Cloneable, Comparable<ReqPositionManualInputOption> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReqPositionManualInputOption");
  ...
  private static final org.apache.thrift.protocol.TField START_TRADE_TIMESTAMP_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("startTradeTimestampMs", org.apache.thrift.protocol.TType.I64, (short)4);
  private static final org.apache.thrift.protocol.TField END_TRADE_TIMESTAMP_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("endTradeTimestampMs", org.apache.thrift.protocol.TType.I64, (short)5);
  private static final org.apache.thrift.protocol.TField INPUT_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("inputId", org.apache.thrift.protocol.TType.I64, (short)6);
  ...
  private static final org.apache.thrift.protocol.TField ASSIGN_SUB_USER_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("assignSubUserId", org.apache.thrift.protocol.TType.I64, (short)8);
  private static final org.apache.thrift.protocol.TField POSITION_DIRECTION_FIELD_DESC = new org.apache.thrift.protocol.TField("positionDirection", org.apache.thrift.protocol.TType.I32, (short)9);
  private static final org.apache.thrift.protocol.TField START_INPUT_TIMESTAMP_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("startInputTimestampMs", org.apache.thrift.protocol.TType.I64, (short)10);
  private static final org.apache.thrift.protocol.TField END_INPUT_TIMESTAMP_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("endInputTimestampMs", org.apache.thrift.protocol.TType.I64, (short)11);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ReqPositionManualInputOptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReqPositionManualInputOptionTupleSchemeFactory());
  }
  ...
  public long assignSubUserId; // optional
  /**
   * 
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    START_TRADE_TIMESTAMP_MS((short)4, "startTradeTimestampMs"),
    END_TRADE_TIMESTAMP_MS((short)5, "endTradeTimestampMs"),
    INPUT_ID((short)6, "inputId"),
    SUB_ACCOUNT_ID((short)7, "subAccountId"),
    ASSIGN_SUB_USER_ID((short)8, "assignSubUserId"),
    /**
     * 
     * @see xueqiao.trade.hosting.position.adjust.assign.thriftapi.PositionDirection
     */
    POSITION_DIRECTION((short)9, "positionDirection"),
    START_INPUT_TIMESTAMP_MS((short)10, "startInputTimestampMs"),
    END_INPUT_TIMESTAMP_MS((short)11, "endInputTimestampMs");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // START_TRADE_TIMESTAMP_MS
          return START_TRADE_TIMESTAMP_MS;
        case 5: // END_TRADE_TIMESTAMP_MS
          return END_TRADE_TIMESTAMP_MS;
        case 6: // INPUT_ID
          return INPUT_ID;
        case 7: // SUB_ACCOUNT_ID
          return SUB_ACCOUNT_ID;
        case 8: // ASSIGN_SUB_USER_ID
          return ASSIGN_SUB_USER_ID;
        case 9: // POSITION_DIRECTION
          return POSITION_DIRECTION;
        case 10: // START_INPUT_TIMESTAMP_MS
          return START_INPUT_TIMESTAMP_MS;
        case 11: // END_INPUT_TIMESTAMP_MS
  ...
  private static final int __STARTTRADETIMESTAMPMS_ISSET_ID = 3;
  private static final int __ENDTRADETIMESTAMPMS_ISSET_ID = 4;
  private static final int __INPUTID_ISSET_ID = 5;
  private static final int __SUBACCOUNTID_ISSET_ID = 6;
  private static final int __ASSIGNSUBUSERID_ISSET_ID = 7;
  private static final int __STARTINPUTTIMESTAMPMS_ISSET_ID = 8;
  private static final int __ENDINPUTTIMESTAMPMS_ISSET_ID = 9;
  private short __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.TRADE_ACCOUNT_ID,_Fields.SUB_USER_ID,_Fields.SLED_CONTRACT_ID,_Fields.START_TRADE_TIMESTAMP_MS,_Fields.END_TRADE_TIMESTAMP_MS,_Fields.INPUT_ID,_Fields.SUB_ACCOUNT_ID,_Fields.ASSIGN_SUB_USER_ID,_Fields.POSITION_DIRECTION,_Fields.START_INPUT_TIMESTAMP_MS,_Fields.END_INPUT_TIMESTAMP_MS};
  ...
  static {
    ...
    tmpMap.put(_Fields.SUB_ACCOUNT_ID, new org.apache.thrift.meta_data.FieldMetaData("subAccountId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.ASSIGN_SUB_USER_ID, new org.apache.thrift.meta_data.FieldMetaData("assignSubUserId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReqPositionManualInputOption.class, metaDataMap);
  }
   ...
   */
  public ReqPositionManualInputOption(ReqPositionManualInputOption other) {
    ...
    this.assignSubUserId = other.assignSubUserId;
  ...
  public ReqPositionManualInputOption deepCopy() {
    return new ReqPositionManualInputOption(this);
  }
  ...
  public void clear() {
    ...
    this.subAccountId = 0;
    setAssignSubUserIdIsSet(false);
    this.assignSubUserId = 0;
  ...
  public ReqPositionManualInputOption setTradeAccountId(long tradeAccountId) {
  ...
  public ReqPositionManualInputOption setSubUserId(long subUserId) {
  ...
  public ReqPositionManualInputOption setSledContractId(long sledContractId) {
  ...
  public ReqPositionManualInputOption setStartTradeTimestampMs(long startTradeTimestampMs) {
  ...
  public ReqPositionManualInputOption setEndTradeTimestampMs(long endTradeTimestampMs) {
  ...
  public ReqPositionManualInputOption setInputId(long inputId) {
  ...
  public ReqPositionManualInputOption setSubAccountId(long subAccountId) {
  ...
  public long getAssignSubUserId() {
    return this.assignSubUserId;
  }

  public ReqPositionManualInputOption setAssignSubUserId(long assignSubUserId) {
    this.assignSubUserId = assignSubUserId;
    setAssignSubUserIdIsSet(true);
    return this;
  }

  public void unsetAssignSubUserId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ASSIGNSUBUSERID_ISSET_ID);
  }

  /** Returns true if field assignSubUserId is set (has been assigned a value) and false otherwise */
  public boolean isSetAssignSubUserId() {
    return EncodingUtils.testBit(__isset_bitfield, __ASSIGNSUBUSERID_ISSET_ID);
  }

  public void setAssignSubUserIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ASSIGNSUBUSERID_ISSET_ID, value);
  }
   ...
   * @see xueqiao.trade.hosting.position.adjust.assign.thriftapi.PositionDirection
   */
  public ReqPositionManualInputOption setPositionDirection(xueqiao.trade.hosting.position.adjust.assign.thriftapi.PositionDirection positionDirection) {
  ...
  public ReqPositionManualInputOption setStartInputTimestampMs(long startInputTimestampMs) {
  ...
  public ReqPositionManualInputOption setEndInputTimestampMs(long endInputTimestampMs) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ASSIGN_SUB_USER_ID:
      if (value == null) {
        unsetAssignSubUserId();
      } else {
        setAssignSubUserId((Long)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ASSIGN_SUB_USER_ID:
      return Long.valueOf(getAssignSubUserId());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReqPositionManualInputOption)
      return this.equals((ReqPositionManualInputOption)that);
    return false;
  }

  public boolean equals(ReqPositionManualInputOption that) {
    if (that == null)
      return false;
    ...
    boolean this_present_assignSubUserId = true && this.isSetAssignSubUserId();
    boolean that_present_assignSubUserId = true && that.isSetAssignSubUserId();
    if (this_present_assignSubUserId || that_present_assignSubUserId) {
      if (!(this_present_assignSubUserId && that_present_assignSubUserId))
        return false;
      if (this.assignSubUserId != that.assignSubUserId)
        return false;
    }
  ...
  @Override
  public int compareTo(ReqPositionManualInputOption other) {
    ...
    lastComparison = Boolean.valueOf(isSetAssignSubUserId()).compareTo(other.isSetAssignSubUserId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAssignSubUserId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.assignSubUserId, other.assignSubUserId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetAssignSubUserId()) {
      ...
      sb.append(this.assignSubUserId);
      first = false;
    }
    if (isSetPositionDirection()) {
      if (!first) sb.append(", ");
  ...
  private static class ReqPositionManualInputOptionStandardSchemeFactory implements SchemeFactory {
    public ReqPositionManualInputOptionStandardScheme getScheme() {
      return new ReqPositionManualInputOptionStandardScheme();
    }
  }

  private static class ReqPositionManualInputOptionStandardScheme extends StandardScheme<ReqPositionManualInputOption> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReqPositionManualInputOption struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // ASSIGN_SUB_USER_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.assignSubUserId = iprot.readI64();
              struct.setAssignSubUserIdIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqPositionManualInputOption struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetAssignSubUserId()) {
        oprot.writeFieldBegin(ASSIGN_SUB_USER_ID_FIELD_DESC);
        oprot.writeI64(struct.assignSubUserId);
        oprot.writeFieldEnd();
      }
  ...
  private static class ReqPositionManualInputOptionTupleSchemeFactory implements SchemeFactory {
    public ReqPositionManualInputOptionTupleScheme getScheme() {
      return new ReqPositionManualInputOptionTupleScheme();
    }
  }

  private static class ReqPositionManualInputOptionTupleScheme extends TupleScheme<ReqPositionManualInputOption> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReqPositionManualInputOption struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReqPositionManualInputOption struct) throws org.apache.thrift.TException {
