...
public class XQSpecMarginSettings implements org.apache.thrift.TBase<XQSpecMarginSettings, XQSpecMarginSettings._Fields>, java.io.Serializable, Cloneable, Comparable<XQSpecMarginSettings> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("XQSpecMarginSettings");
  ...
  private static final org.apache.thrift.protocol.TField MARGIN_DELTA_FIELD_DESC = new org.apache.thrift.protocol.TField("marginDelta", org.apache.thrift.protocol.TType.STRUCT, (short)10);
  ...
  static {
    schemes.put(StandardScheme.class, new XQSpecMarginSettingsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new XQSpecMarginSettingsTupleSchemeFactory());
  }
  ...
  public MarginInfo marginDelta; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     */
    TYPE((short)5, "type"),
    MARGIN_DELTA((short)10, "marginDelta"),
  ...
  private _Fields optionals[] = {_Fields.SUB_ACCOUNT_ID,_Fields.COMMODITY_ID,_Fields.COMMODITY_INFO,_Fields.TYPE,_Fields.MARGIN_DELTA,_Fields.IS_SYNC,_Fields.CREATE_TIMESTAMP_MS,_Fields.LASTMODIFY_TIMESTAMP_MS};
  ...
  static {
    ...
    tmpMap.put(_Fields.MARGIN_DELTA, new org.apache.thrift.meta_data.FieldMetaData("marginDelta", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(XQSpecMarginSettings.class, metaDataMap);
  }
   ...
   */
  public XQSpecMarginSettings(XQSpecMarginSettings other) {
    ...
    if (other.isSetMarginDelta()) {
      this.marginDelta = new MarginInfo(other.marginDelta);
    }
  ...
  public XQSpecMarginSettings deepCopy() {
    return new XQSpecMarginSettings(this);
  }
  ...
  public XQSpecMarginSettings setSubAccountId(long subAccountId) {
  ...
  public XQSpecMarginSettings setCommodityId(long commodityId) {
  ...
  public XQSpecMarginSettings setCommodityInfo(CommodityInfo commodityInfo) {
   ...
   * @see FeeCalculateType
   */
  public XQSpecMarginSettings setType(FeeCalculateType type) {
    this.type = type;
    return this;
  }
  ...
  public MarginInfo getMarginDelta() {
    return this.marginDelta;
  }

  public XQSpecMarginSettings setMarginDelta(MarginInfo marginDelta) {
    this.marginDelta = marginDelta;
    return this;
  }

  public void unsetMarginDelta() {
    this.marginDelta = null;
  }

  /** Returns true if field marginDelta is set (has been assigned a value) and false otherwise */
  public boolean isSetMarginDelta() {
    return this.marginDelta != null;
  }

  public void setMarginDeltaIsSet(boolean value) {
    if (!value) {
      this.marginDelta = null;
    }
  }
  ...
  public XQSpecMarginSettings setIsSync(boolean isSync) {
    this.isSync = isSync;
    setIsSyncIsSet(true);
    return this;
  }
  ...
  public XQSpecMarginSettings setCreateTimestampMs(long createTimestampMs) {
  ...
  public XQSpecMarginSettings setLastmodifyTimestampMs(long lastmodifyTimestampMs) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MARGIN_DELTA:
      if (value == null) {
        ...
        setMarginDelta((MarginInfo)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof XQSpecMarginSettings)
      return this.equals((XQSpecMarginSettings)that);
    return false;
  }

  public boolean equals(XQSpecMarginSettings that) {
    if (that == null)
      return false;
    ...
    boolean this_present_marginDelta = true && this.isSetMarginDelta();
    boolean that_present_marginDelta = true && that.isSetMarginDelta();
    if (this_present_marginDelta || that_present_marginDelta) {
      if (!(this_present_marginDelta && that_present_marginDelta))
        return false;
      if (!this.marginDelta.equals(that.marginDelta))
        return false;
    }
  ...
  @Override
  public int compareTo(XQSpecMarginSettings other) {
    ...
    lastComparison = Boolean.valueOf(isSetMarginDelta()).compareTo(other.isSetMarginDelta());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMarginDelta()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.marginDelta, other.marginDelta);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class XQSpecMarginSettingsStandardSchemeFactory implements SchemeFactory {
    public XQSpecMarginSettingsStandardScheme getScheme() {
      return new XQSpecMarginSettingsStandardScheme();
    }
  }

  private static class XQSpecMarginSettingsStandardScheme extends StandardScheme<XQSpecMarginSettings> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, XQSpecMarginSettings struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 10: // MARGIN_DELTA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.marginDelta = new MarginInfo();
              struct.marginDelta.read(iprot);
              struct.setMarginDeltaIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, XQSpecMarginSettings struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.marginDelta != null) {
        if (struct.isSetMarginDelta()) {
          oprot.writeFieldBegin(MARGIN_DELTA_FIELD_DESC);
          struct.marginDelta.write(oprot);
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class XQSpecMarginSettingsTupleSchemeFactory implements SchemeFactory {
    public XQSpecMarginSettingsTupleScheme getScheme() {
      return new XQSpecMarginSettingsTupleScheme();
    }
  }

  private static class XQSpecMarginSettingsTupleScheme extends TupleScheme<XQSpecMarginSettings> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, XQSpecMarginSettings struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, XQSpecMarginSettings struct) throws org.apache.thrift.TException {
