...
public class XQContractCommission implements org.apache.thrift.TBase<XQContractCommission, XQContractCommission._Fields>, java.io.Serializable, Cloneable, Comparable<XQContractCommission> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("XQContractCommission");
  ...
  static {
    schemes.put(StandardScheme.class, new XQContractCommissionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new XQContractCommissionTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.SUB_ACCOUNT_ID,_Fields.CONTRACT_INFO,_Fields.COMMISSION,_Fields.DATA_TYPE,_Fields.SETTINGS_DATA_TYPE,_Fields.CREATE_TIMESTAMP_MS,_Fields.LASTMODIFY_TIMESTAMP_MS};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(XQContractCommission.class, metaDataMap);
  }
   ...
   */
  public XQContractCommission(XQContractCommission other) {
  ...
  public XQContractCommission deepCopy() {
    return new XQContractCommission(this);
  }
  ...
  public XQContractCommission setSubAccountId(long subAccountId) {
  ...
  public XQContractCommission setContractInfo(ContractInfo contractInfo) {
  ...
  public XQContractCommission setCommission(CommissionInfo commission) {
   ...
   * @see UpsideDataType
   */
  public XQContractCommission setDataType(UpsideDataType dataType) {
   ...
   * @see XQSettingsDataType
   */
  public XQContractCommission setSettingsDataType(XQSettingsDataType settingsDataType) {
  ...
  public XQContractCommission setCreateTimestampMs(long createTimestampMs) {
  ...
  public XQContractCommission setLastmodifyTimestampMs(long lastmodifyTimestampMs) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof XQContractCommission)
      return this.equals((XQContractCommission)that);
    return false;
  }

  public boolean equals(XQContractCommission that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(XQContractCommission other) {
  ...
  private static class XQContractCommissionStandardSchemeFactory implements SchemeFactory {
    public XQContractCommissionStandardScheme getScheme() {
      return new XQContractCommissionStandardScheme();
    }
  }

  private static class XQContractCommissionStandardScheme extends StandardScheme<XQContractCommission> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, XQContractCommission struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, XQContractCommission struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class XQContractCommissionTupleSchemeFactory implements SchemeFactory {
    public XQContractCommissionTupleScheme getScheme() {
      return new XQContractCommissionTupleScheme();
    }
  }

  private static class XQContractCommissionTupleScheme extends TupleScheme<XQContractCommission> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, XQContractCommission struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, XQContractCommission struct) throws org.apache.thrift.TException {
