...
public class TradeHostingUpsideEntryAsyncStub extends BaseStub { 
  ...
  protected TServiceCall create_getSubProcessInfosServiceCall(int routeKey, int timeout, PlatformArgs platformArgs){
  ...
  protected TServiceCall create_restartSubProcessServiceCall(int routeKey, int timeout, PlatformArgs platformArgs, long trade_account_id){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_allocOrderRefServiceCall(int routeKey, int timeout, PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_orderInsertServiceCall(int routeKey, int timeout, PlatformArgs platformArgs, xueqiao.trade.hosting.HostingExecOrder insertOrder){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_orderDeleteServiceCall(int routeKey, int timeout, PlatformArgs platformArgs, xueqiao.trade.hosting.HostingExecOrder deleteOrder){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_syncOrderStateServiceCall(int routeKey, int timeout, PlatformArgs platformArgs, xueqiao.trade.hosting.HostingExecOrder syncOrder){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_syncOrderTradesServiceCall(int routeKey, int timeout, PlatformArgs platformArgs, xueqiao.trade.hosting.HostingExecOrder syncOrder){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_syncOrderStateBatchServiceCall(int routeKey, int timeout, PlatformArgs platformArgs, TSyncOrderStateBatchReq batchReq){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_getLastUpsideEffectiveTimestampServiceCall(int routeKey, int timeout, PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_sendUpsideHeartBeatServiceCall(int routeKey, int timeout, PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_dumpPositionSummariesServiceCall(int routeKey, int timeout, PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_getFundsServiceCall(int routeKey, int timeout, PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_getSettlementInfoServiceCall(int routeKey, int timeout, PlatformArgs platformArgs, String settlementDate){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
  ...
  protected TServiceCall create_getNetPositionSummariesServiceCall(int routeKey, int timeout, PlatformArgs platformArgs){
    TServiceCall serviceCall = new TServiceCall();
    if (!getPeerAddr().isEmpty()) {
      serviceCall.setChooseServiceIp(getPeerAddr());
    }
