...
public class TradeHostingUpsideEntryStub extends BaseStub {
  ...
  public List<TSubProcessInfo>  getSubProcessInfos() throws ErrorInfo, TException{
    return getSubProcessInfos(new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public List<TSubProcessInfo>  getSubProcessInfos(TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public List<TSubProcessInfo>  getSubProcessInfos(int routeKey, int timeout)throws ErrorInfo, TException{
  ...
  public void  restartSubProcess(long trade_account_id) throws ErrorInfo, TException{
    restartSubProcess(trade_account_id, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  restartSubProcess(long trade_account_id,TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public void  restartSubProcess(int routeKey, int timeout,long trade_account_id)throws ErrorInfo, TException{
  ...
  public xueqiao.trade.hosting.HostingExecOrderRef  allocOrderRef() throws ErrorInfo, TException{
    return allocOrderRef(new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public xueqiao.trade.hosting.HostingExecOrderRef  allocOrderRef(TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public xueqiao.trade.hosting.HostingExecOrderRef  allocOrderRef(int routeKey, int timeout)throws ErrorInfo, TException{
  ...
  public void  orderInsert(xueqiao.trade.hosting.HostingExecOrder insertOrder) throws ErrorInfo, TException{
    orderInsert(insertOrder, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  orderInsert(xueqiao.trade.hosting.HostingExecOrder insertOrder,TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public void  orderInsert(int routeKey, int timeout,xueqiao.trade.hosting.HostingExecOrder insertOrder)throws ErrorInfo, TException{
  ...
  public void  orderDelete(xueqiao.trade.hosting.HostingExecOrder deleteOrder) throws ErrorInfo, TException{
    orderDelete(deleteOrder, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  orderDelete(xueqiao.trade.hosting.HostingExecOrder deleteOrder,TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public void  orderDelete(int routeKey, int timeout,xueqiao.trade.hosting.HostingExecOrder deleteOrder)throws ErrorInfo, TException{
  ...
  public void  syncOrderState(xueqiao.trade.hosting.HostingExecOrder syncOrder) throws ErrorInfo, TException{
    syncOrderState(syncOrder, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  syncOrderState(xueqiao.trade.hosting.HostingExecOrder syncOrder,TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public void  syncOrderState(int routeKey, int timeout,xueqiao.trade.hosting.HostingExecOrder syncOrder)throws ErrorInfo, TException{
  ...
  public void  syncOrderTrades(xueqiao.trade.hosting.HostingExecOrder syncOrder) throws ErrorInfo, TException{
    syncOrderTrades(syncOrder, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  syncOrderTrades(xueqiao.trade.hosting.HostingExecOrder syncOrder,TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public void  syncOrderTrades(int routeKey, int timeout,xueqiao.trade.hosting.HostingExecOrder syncOrder)throws ErrorInfo, TException{
  ...
  public void  syncOrderStateBatch(TSyncOrderStateBatchReq batchReq) throws ErrorInfo, TException{
    syncOrderStateBatch(batchReq, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  syncOrderStateBatch(TSyncOrderStateBatchReq batchReq,TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public void  syncOrderStateBatch(int routeKey, int timeout,TSyncOrderStateBatchReq batchReq)throws ErrorInfo, TException{
  ...
  public long  getLastUpsideEffectiveTimestamp() throws ErrorInfo, TException{
    return getLastUpsideEffectiveTimestamp(new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public long  getLastUpsideEffectiveTimestamp(TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public long  getLastUpsideEffectiveTimestamp(int routeKey, int timeout)throws ErrorInfo, TException{
  ...
  public void  sendUpsideHeartBeat() throws ErrorInfo, TException{
    sendUpsideHeartBeat(new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public void  sendUpsideHeartBeat(TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public void  sendUpsideHeartBeat(int routeKey, int timeout)throws ErrorInfo, TException{
  ...
  public List<xueqiao.trade.hosting.upside.position.PositionSummary>  dumpPositionSummaries() throws ErrorInfo, TException{
    return dumpPositionSummaries(new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public List<xueqiao.trade.hosting.upside.position.PositionSummary>  dumpPositionSummaries(TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public List<xueqiao.trade.hosting.upside.position.PositionSummary>  dumpPositionSummaries(int routeKey, int timeout)throws ErrorInfo, TException{
  ...
  public List<TFund>  getFunds() throws ErrorInfo, TException{
    return getFunds(new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public List<TFund>  getFunds(TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public List<TFund>  getFunds(int routeKey, int timeout)throws ErrorInfo, TException{
  ...
  public TSettlementInfo  getSettlementInfo(String settlementDate) throws ErrorInfo, TException{
    return getSettlementInfo(settlementDate, new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public TSettlementInfo  getSettlementInfo(String settlementDate,TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public TSettlementInfo  getSettlementInfo(int routeKey, int timeout,String settlementDate)throws ErrorInfo, TException{
  ...
  public List<TNetPositionSummary>  getNetPositionSummaries() throws ErrorInfo, TException{
    return getNetPositionSummaries(new TStubOption().setCallTrace(Thread.currentThread().getStackTrace()[2]));
  }

  public List<TNetPositionSummary>  getNetPositionSummaries(TStubOption platformStubOption) throws ErrorInfo, TException {
  ...
  public List<TNetPositionSummary>  getNetPositionSummaries(int routeKey, int timeout)throws ErrorInfo, TException{
