...
public class HostingInfo implements org.apache.thrift.TBase<HostingInfo, HostingInfo._Fields>, java.io.Serializable, Cloneable, Comparable<HostingInfo> {
  ...
  private static final org.apache.thrift.protocol.TField BUILD_VERSION_FIELD_DESC = new org.apache.thrift.protocol.TField("buildVersion", org.apache.thrift.protocol.TType.STRING, (short)8);
  ...
  public String buildVersion; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BUILD_VERSION((short)8, "buildVersion");
  ...
  private _Fields optionals[] = {_Fields.STATUS,_Fields.TABLE_VERSION,_Fields.SUB_USER_TOTAL_COUNT,_Fields.COMPOSE_TOTAL_COUNT,_Fields.ONLINE_USER_TOTAL_COUNT,_Fields.MACHINE_ID,_Fields.RUNNING_MODE,_Fields.BUILD_VERSION};
  ...
  static {
    ...
    tmpMap.put(_Fields.BUILD_VERSION, new org.apache.thrift.meta_data.FieldMetaData("buildVersion", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public HostingInfo setBuildVersion(String buildVersion) {
  ...
  public int compareTo(HostingInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetBuildVersion()).compareTo(other.isSetBuildVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBuildVersion()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.buildVersion, other.buildVersion);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
